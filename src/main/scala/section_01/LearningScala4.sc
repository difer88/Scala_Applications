object LearningScala4 {
  ...
  // module operator, like other languages, is %, which gives you the remainder after division. For example, 9 % 3 = 0
  ...
  val numberListTest = List(6, 7, 8, 9, 15, 23, 46, 96)
                                                  //> numberListTest  : List[Int] = List(6, 7, 8, 9, 15, 23, 46, 96)

  for (number <- numberListTest) {
    if (number % 3 == 0){
      println(number)
    }                                             //> 6
                                                  //| 9
  ...
  val divisiblesByThree = numberListTest.filter((x : Int) => x % 3 == 0)
                                                  //> divisiblesByThree  : List[Int] = List(6, 9, 15, 96)

  for(number <- divisiblesByThree){
    println(number)                               //> 6
                                                  //| 9
                                                  //| 15
                                                  //| 96
	...
	val numberListToMultiply = List(2, 5, 8, 9, 15, 23)
                                                  //> numberListToMultiply  : List[Int] = List(2, 5, 8, 9, 15, 23)
  val multipliedList = numberListToMultiply.map(x => x * x)
                                                  //> multipliedList  : List[Int] = List(4, 25, 64, 81, 225, 529)
